...
<header class="header">
    ...
    <div class="header_content d-flex flex-row align-items-center justify-content-start">
        ...
        <div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
            ...
            <!-- Cart -->
            <div class="cart" id="user_cart"><a href="{{ route('cart.index')}}" title="ir al carrito"><div><img class="svg" src="{{ asset('asset/images/cart.svg') }}" alt="https://www.flaticon.com/authors/freepik"><div>{{--<user-cart :user_id="{{ auth()->user() ? json_encode(auth()->id()) : '0' }}"></user-cart>--}}<div v-text="productos.data"></div></div></div></a></div>
